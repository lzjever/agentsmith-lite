  ...
  it("accepts generated OIDC substrate env/secrets while exporting only app-consumed keys", () => {
    ...
    writeFileSync(
      ...
      [
        ...
        "KEYCLOAK_DB_USER=DO_NOT_PRINT_KEYCLOAK_DB_USER",
        "KEYCLOAK_DB_PASSWORD=DO_NOT_PRINT_KEYCLOAK_DB_PASSWORD",
        "KEYCLOAK_DB_DATABASE=DO_NOT_PRINT_KEYCLOAK_DB_DATABASE",
        "KEYCLOAK_ADMIN_USERNAME=DO_NOT_PRINT_KEYCLOAK_ADMIN_USERNAME",
        "KEYCLOAK_ADMIN_PASSWORD=DO_NOT_PRINT_KEYCLOAK_ADMIN_PASSWORD",
