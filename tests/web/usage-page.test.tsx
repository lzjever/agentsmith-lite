...
describe("usage page", () => {
  it("renders server-computed limit cards and requests an endpoint-filtered trend", async () => {
    ...
    try {
      ...
      assert.equal(screen.queryByRole("link", { name: /Task task_settled/ }), null);
      assert.ok(screen.getByTitle("This task was deleted"));
