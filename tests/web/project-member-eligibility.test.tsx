...
const capabilities: ProjectCapabilities = { canManageEndpoints: false, canManageMembers: true, canManagePolicy: false, canWriteFiles: false, canCreateTasks: false, canSendChat: false };
