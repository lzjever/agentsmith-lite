...
const capabilities: ProjectCapabilities = { canManageEndpoints: false, canManageMembers: false, canManagePolicy: true, canWriteFiles: true, canCreateTasks: true, canSendChat: true };
