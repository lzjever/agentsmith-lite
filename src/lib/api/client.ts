...
export const apiClient = {
  ...
  updateProjectSettings: (projectId: string, input: { name?: string }, idempotencyKey: string) => jsonIdempotent<ProjectSettings>(`/projects/${encodeURIComponent(projectId)}/settings`, "PATCH", idempotencyKey, input),
