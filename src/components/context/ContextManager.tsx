...
export function ContextManager({ workspaceId, projectId }: { workspaceId: string; projectId?: string }) {
  ...
  async function save() {
    ...
    try {
      ...
      await load(); setSelectedKey(saved.contextKey); toast.success("Context saved");
  ...
  async function remove() {
    ...
    try {
      ...
      create(); await load(); setDeleteOpen(false); toast.success("Context deleted");
