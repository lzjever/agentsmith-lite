...
async function insertTaskWithClient(client: PoolClient, task: PersistedAgentTask, activeReservation: boolean): Promise<AgentTaskRow> {
  const columns = [
    "id","workspace_id","project_id","endpoint_id","title","prompt","agent_context","input_paths","status","run_id","source_task_id","execution_mode","active_reservation","archived_at","deleted_at","terminal_reason","terminalized_at",
