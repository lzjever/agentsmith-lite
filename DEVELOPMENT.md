...
The operator lifecycle e2e and browser visual checks are manual commands, not default test commands. Use `scripts/deploy/render.sh` and `scripts/deploy/apply.sh` for app deployment.
