...
- A sandbox controller package that renders namespaced sandbox manifests, reconciles the six lifecycle resources in tests, and includes a low-dependency in-cluster Kubernetes port/action applier; TaskService live materialization/readiness wiring remains separate.
